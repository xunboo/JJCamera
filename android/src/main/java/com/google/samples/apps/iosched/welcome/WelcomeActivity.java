 ...
 */
package com.jjcamera.apps.iosched.welcome;
 ...
 * {@link com.jjcamera.apps.iosched.core.activities.BaseActivity} functionality.
 */
public class WelcomeActivity extends AppCompatActivity implements WelcomeFragment.WelcomeFragmentContainer {
     ...
     */
    private void displayJJCameraWarningDialog() {
        new AlertDialog.Builder(this)
                .setTitle(Config.JJCAMERA_BUILD_WARNING_TITLE)
                .setMessage(Config.JJCAMERA_BUILD_WARNING_TEXT)
