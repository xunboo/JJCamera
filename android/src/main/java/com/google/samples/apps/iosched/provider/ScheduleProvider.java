...
package com.jjcamera.apps.iosched.provider;

import com.jjcamera.apps.iosched.Config;
import com.jjcamera.apps.iosched.appwidget.ScheduleWidgetProvider;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Announcements;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Blocks;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Feedback;
import com.jjcamera.apps.iosched.provider.ScheduleContract.HashtagColumns;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Hashtags;
import com.jjcamera.apps.iosched.provider.ScheduleContract.MapMarkers;
import com.jjcamera.apps.iosched.provider.ScheduleContract.MapTiles;
import com.jjcamera.apps.iosched.provider.ScheduleContract.MyFeedbackSubmitted;
import com.jjcamera.apps.iosched.provider.ScheduleContract.MySchedule;
import com.jjcamera.apps.iosched.provider.ScheduleContract.MyScheduleColumns;
import com.jjcamera.apps.iosched.provider.ScheduleContract.MyViewedVideos;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Rooms;
import com.jjcamera.apps.iosched.provider.ScheduleContract.SearchSuggest;
import com.jjcamera.apps.iosched.provider.ScheduleContract.SearchTopicsSessions;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Sessions;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Speakers;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Tags;
import com.jjcamera.apps.iosched.provider.ScheduleContract.VideoColumns;
import com.jjcamera.apps.iosched.provider.ScheduleContract.Videos;
import com.jjcamera.apps.iosched.provider.ScheduleDatabase.SessionsSearchColumns;
import com.jjcamera.apps.iosched.provider.ScheduleDatabase.SessionsSpeakers;
import com.jjcamera.apps.iosched.provider.ScheduleDatabase.Tables;
import com.jjcamera.apps.iosched.settings.SettingsUtils;
import com.jjcamera.apps.iosched.util.AccountUtils;
import com.jjcamera.apps.iosched.util.SelectionBuilder;
 ...
 * usually inserted by {@link com.jjcamera.apps.iosched.sync.SyncHelper}, and queried using
...
public class ScheduleProvider extends ContentProvider {
     ...
     * parameter is used by the {@link com.jjcamera.apps.iosched.explore.ExploreSessionsActivity}
     ...
     * {@link com.jjcamera.apps.iosched.sync.ConferenceDataHandler} notifies all top level
     * conference paths once the conference data sync is done, and the
     * {@link com.jjcamera.apps.iosched.sync.userdata.AbstractUserDataSyncHelper} notifies all
