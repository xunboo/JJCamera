...
package com.jjcamera.apps.iosched.videolibrary;
...
import com.jjcamera.apps.iosched.util.ParserUtils;
 ...
 * {@link com.jjcamera.apps.iosched.framework.PresenterFragmentImpl}.
 */
public class VideoLibraryModel implements Model {

    private static final String TAG = makeLogTag(VideoLibraryModel.class);

    protected static final String KEY_YEAR = "com.jjcamera.apps.iosched.KEY_YEAR";

    protected static final String KEY_TOPIC = "com.jjcamera.apps.iosched.KEY_TOPIC";

    protected static final String KEY_VIDEO_ID = "com.jjcamera.apps.iosched.KEY_VIDEO_ID";
