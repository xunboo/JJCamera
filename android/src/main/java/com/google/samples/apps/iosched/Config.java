...
public class Config {
    ...
    public static final String JJCAMERA_BUILD_WARNING_TITLE = "JJCAMERA BUILD";

    public static final String JJCAMERA_BUILD_WARNING_TEXT = "Shhh! This is a pre-release build "
