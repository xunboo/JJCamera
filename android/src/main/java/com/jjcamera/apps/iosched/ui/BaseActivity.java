...
package com.jjcamera.apps.iosched.ui;
...
import com.jjcamera.apps.iosched.about.AboutActivity;
import com.jjcamera.apps.iosched.debug.DebugActivity;
...
import com.jjcamera.apps.iosched.settings.SettingsActivity;
import com.jjcamera.apps.iosched.settings.SettingsUtils;
import com.jjcamera.apps.iosched.social.SocialActivity;
import com.jjcamera.apps.iosched.sync.SyncHelper;
import com.jjcamera.apps.iosched.ui.widget.MultiSwipeRefreshLayout;
import com.jjcamera.apps.iosched.ui.widget.NavDrawerItemView;
import com.jjcamera.apps.iosched.ui.widget.ScrimInsetsScrollView;
import com.jjcamera.apps.iosched.util.AccountUtils;
import com.jjcamera.apps.iosched.util.ImageLoader;
import com.jjcamera.apps.iosched.util.LUtils;
import com.jjcamera.apps.iosched.util.LoginAndAuthHelper;
import com.jjcamera.apps.iosched.util.RecentTasksStyler;
import com.jjcamera.apps.iosched.util.TimeUtils;
import com.jjcamera.apps.iosched.util.UIUtils;
import com.jjcamera.apps.iosched.videolibrary.VideoLibraryActivity;
...
public abstract class BaseActivity extends AppCompatActivity implements
    ...
    /**
     * Adds a {@link com.jjcamera.apps.iosched.framework.PresenterFragmentImpl} to the
     * Activity if required, and sets it up with the {@code model}, {@code queries},
     * {@code actions} and the {@link com.jjcamera.apps.iosched.framework.UpdatableView}
     * corresponding to the {@code updatableViewResId}.
     *
     * @return the {@link com.jjcamera.apps.iosched.framework.PresenterFragmentImpl},
     */
     ...
     * {@link com.jjcamera.apps.iosched.util.ThrottledContentObserver} for the given
