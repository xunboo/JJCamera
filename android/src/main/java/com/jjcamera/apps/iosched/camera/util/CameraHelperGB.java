...
package com.jjcamera.apps.iosched.camera.util;

import android.annotation.TargetApi;
import android.hardware.Camera;
import android.hardware.Camera.CameraInfo;

import com.jjcamera.apps.iosched.camera.util.CameraHelper.CameraHelperImpl;
import com.jjcamera.apps.iosched.camera.util.CameraHelper.CameraInfo2;
