...
package com.jjcamera.apps.iosched.streaming;
...
import com.jjcamera.apps.iosched.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(com.jjcamera.apps.iosched.streaming.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link com.jjcamera.apps.iosched.streaming.rtp.RtpSocket}.
