...
package com.jjcamera.apps.iosched.service;
...
public class SessionCalendarService extends IntentService {
    ...
    public static final String ACTION_ADD_SESSION_CALENDAR =
            "com.jjcamera.apps.iosched.action.ADD_SESSION_CALENDAR";
    public static final String ACTION_REMOVE_SESSION_CALENDAR =
            "com.jjcamera.apps.iosched.action.REMOVE_SESSION_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR =
            "com.jjcamera.apps.iosched.action.UPDATE_ALL_SESSIONS_CALENDAR";
    public static final String ACTION_UPDATE_ALL_SESSIONS_CALENDAR_COMPLETED =
            "com.jjcamera.apps.iosched.action.UPDATE_CALENDAR_COMPLETED";
    public static final String ACTION_CLEAR_ALL_SESSIONS_CALENDAR =
            "com.jjcamera.apps.iosched.action.CLEAR_ALL_SESSIONS_CALENDAR";
    public static final String EXTRA_ACCOUNT_NAME =
            "com.jjcamera.apps.iosched.extra.ACCOUNT_NAME";
    public static final String EXTRA_SESSION_START =
            "com.jjcamera.apps.iosched.extra.SESSION_BLOCK_START";
    public static final String EXTRA_SESSION_END =
            "com.jjcamera.apps.iosched.extra.SESSION_BLOCK_END";
    public static final String EXTRA_SESSION_TITLE =
            "com.jjcamera.apps.iosched.extra.SESSION_TITLE";
    public static final String EXTRA_SESSION_ROOM =
            "com.jjcamera.apps.iosched.extra.SESSION_ROOM";
     ...
     * {@link com.jjcamera.apps.iosched.provider.ScheduleProvider}, adding or removing
